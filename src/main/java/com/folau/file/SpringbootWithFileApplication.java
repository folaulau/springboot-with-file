...
public class SpringbootWithFileApplication {

	public static void main(String[] args) {
		SpringApplication.run(SpringbootWithFileApplication.class, args);
	}
	...
	public CommandLineRunner commandLineRunner(ApplicationContext ctx) {
		return args -> {
			...
			try {
				...
				System.out.println("******************* Springboo with File ************************");
